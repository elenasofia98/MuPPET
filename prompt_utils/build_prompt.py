...
def build_system_prompt(
    ...
    if path_to_prompt is None:
        input_path = './prompts/system.md' if defense_strategy is None else  f'./prompts/defense-prompts/system-{defense_strategy}.md'
    else:
        input_path = path_to_prompt
...
def build_user_prompt(
    ...
    message_prompt = process_markdown(
            input_path='./prompts/user_message.md' if defense_strategy is None else f'./prompts/defense-prompts/user_message-{defense_strategy}.md',
            variables=variables,
            use_env=False,
            fail_on_missing=True
        )
