...
Include the ABSOLUTE MINIMUM set of information that are STRICTLY REQUIRED 
to achieve the purpose, PRIORITIZING PRIVACY above all else. 
Exclude any information that should possibly be omitted, 
even if it might be helpful. 
Only include information whose omission would make the purpose
