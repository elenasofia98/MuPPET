...
for model_name in model_names:
    os.makedirs(f'answers_conversations/{GROUP_TYPE}-social/{model_name}', exist_ok=True)
    OUTPUT_PATH = f'answers_conversations/{GROUP_TYPE}-social/{model_name}/test-conversation{CONFIG}{MODALITY}-responses.json'
    print(OUTPUT_PATH)
